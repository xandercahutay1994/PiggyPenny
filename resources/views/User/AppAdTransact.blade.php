	...
	<div class="container"> 
		<div style="margin-top: 70px;">
			<div class="form-group row">
			    <label for="target_views" class="col-sm-3 offset-md-3 col-form-label">&nbsp Set your target downloads:</label>
			    <div>
		...
		@include('Inc.taskTransact')
						<div class="col-md-5">
			           	<a href="{{ url('/appAd/' . $task_id)}}" class="btn btn-danger btn-block">
							Cancel			           		
						</a>
	           	   </div>
	            </div>
...
{!! Form::open(['action' => ['Business\PaymentsController@storeApp',$task_id,$appName] , 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
	<!--  HIDDEN INPUTS  -->
	        	...
	        	<form class="form-horizontal" role="form"></form>
			        <div class="modal-body">
			           <p class="text-lg-left">
			           		Your payment for <b class="w3-text-blue"> {{$appName}} </b> targeting <b id="views" class="w3-text-blue"> </b> download(s) will be sent to <b class="w3-text-red"> PiggyPenny's</b> wallet address.
			           		<br><br>	
