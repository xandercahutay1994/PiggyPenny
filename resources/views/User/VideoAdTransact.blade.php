			...
			<div class="form-group row">
			    ...
			    <div style="margin-left:-140px;">
		      		...
		      		<span id="set"></span>
						...
						<div class="col-md-5">
			           	<a href="{{ url('/videoAd/' . $task_id)}}" class="btn btn-danger btn-block">
							Cancel			           		
						</a>
	           	   </div>
	            </div>
...
{!! Form::open(['action' => ['Business\PaymentsController@storeVideo',$task_id,$videoName] , 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
	<!--  HIDDEN INPUTS  -->
	        	...
	        	<form class="form-horizontal" role="form"></form>
			        <div class="modal-body">
			           <p class="text-lg-left">
			           		Your payment for <b class="w3-text-blue"> {{$videoName}} </b> targeting <b id="views" class="w3-text-blue"> </b> views will be sent to <b class="w3-text-red"> PiggyPenny's</b> wallet address.
			           		<br><br>	
			           		...
			           		<label>
			           			<div align="middle">
				           			...
				           			<a href="#" onclick="copyToClipboard('#php')" class="far fa-copy" id="clip2"> Copy PHP</a> <small id="copied2"></small>
