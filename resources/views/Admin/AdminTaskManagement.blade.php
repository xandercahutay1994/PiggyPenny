...
<style type="text/css">
    ...
    <div>
        ...
        <div class="w3-container" style="overflow-x:auto;">
            ...
            <a href="{{ url('admin') }}" class="btn btn-default offset-md-2">
                Go To Dashboard
            </a>
            ...
            <br><br>
            <table class="table table1 responsive" style="margin-left:265px;width: 75%;">
                ...
                @if(count($task_pending) > 0)
                    @foreach($task_pending as $key => $value)
                        <tr style="margin: 0 auto;" class="w3-small text-center">
                            <td >
                                {{$value->btask_id}}
                            </td>
                            <td>
                                            ...
                                            <form class="form-horizontal" role="form"></form>
                                                <div class="modal-body">
                                                    ...
                                                    <div class="modal-footer">
                                                        <div class="col-md-6">
                                                            <a style="text-decoration: none;" href="{{ url('approved_task/' . $value->btask_id) }}">
            ...
            <!-- 
             ...
             -->
            <table class="table table2" style="margin-left: 265px;width: 75%;">
                <thead style="background-color: #c6c6d1">
